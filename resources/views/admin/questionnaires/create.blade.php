                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.questionnaires.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="instructions" name="instructions" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-primary focus:ring-primary">{{ old('instructions') }}</textarea>
