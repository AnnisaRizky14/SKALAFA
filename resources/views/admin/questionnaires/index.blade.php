                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center">
                                @php $bgColor = $questionnaire->faculty->color ?? '#003f7f'; $style = 'style="background-color: ' . $bgColor . '"'; @endphp
                            ...
                            <span class="status-badge inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $questionnaire->is_active ? ($questionnaire->isAvailable() ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800') : 'bg-red-100 text-red-800' }} ml-2">
                                {{ $questionnaire->is_active ? ($questionnaire->isAvailable() ? 'Aktif' : 'Tidak Tersedia') : 'Tidak Aktif' }}
                            </span>
                        </div>

                        <div class="space-y-2 mb-3">
                            <div class="text-xs text-gray-600">
                                <strong>Fakultas:</strong> {{ $questionnaire->faculty->name }}
                            </div>
                            <div class="text-xs text-gray-600">
                                <strong>Respon:</strong> {{ $questionnaire->responses->count() }}
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-2">
                                ...
                                <button type="button"
                                        ...
                                        data-active="{{ $questionnaire->is_active }}"
                    ...
                    <div class="overflow-x-auto min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="status-badge inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $questionnaire->is_active ? ($questionnaire->isAvailable() ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800') : 'bg-red-100 text-red-800' }}">
                                        {{ $questionnaire->is_active ? ($questionnaire->isAvailable() ? 'Aktif & Tersedia' : 'Aktif & Tidak Tersedia') : 'Tidak Aktif' }}
                                    </span>
                                </td>
