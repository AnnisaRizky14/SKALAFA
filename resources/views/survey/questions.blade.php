        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-primary">{{ $questionnaire->title }}</h1>
                        <p class="text-sm text-gray-600">{{ $questionnaire->faculty->name }}</p>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="w-64 progress-bar mt-1">
    ...
    <main class="container mx-auto px-4 py-8">
        <form id="survey-form" action="{{ route('survey.submit') }}" method="POST">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <label class="rating-option flex-1 cursor-pointer">
                                                <input type="radio" 
                                                       name="answers[{{ $question->id }}][rating]" 
                                                       value="{{ $rating }}" 
                                                       class="sr-only"
                                                       {{ $question->is_required ? 'required' : '' }}>
                                                <div class="rating-card bg-gray-50 border-2 border-gray-200 rounded-lg p-3 text-center transition-all duration-200 hover:border-primary hover:bg-blue-50">
                                                    <!-- Star Rating Visual -->
                                                    <div class="flex justify-center mb-2">
                                                        @for($star = 1; $star <= 5; $star++)
                                                        <svg class="w-4 h-4 {{ $star <= $rating ? 'text-yellow-400' : 'text-gray-300' }}" 
                                                    ...
                                                    <div class="text-2xl font-bold text-gray-700 mb-1">{{ $rating }}</div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 text-center">
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Selesaikan Survei</h3>
                ...
                <div class="flex items-center justify-center space-x-4">
                    ...
                    <button type="submit" 
                            id="submit-btn"
                            class="px-8 py-3 btn-primary rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed">
...
<div id="review-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden">
        <div class="p-6 border-b">
            <div class="flex items-center justify-between">
                <h3 class="text-2xl font-bold text-gray-800">Tinjau Jawaban Anda</h3>
        ...
        <div class="p-6 border-t bg-gray-50 flex justify-end space-x-4">
            ...
            <button onclick="submitSurvey()" 
                    class="px-8 py-2 btn-primary rounded-lg font-semibold">
                Kirim Survei
            </button>
        </div>
    </div>
