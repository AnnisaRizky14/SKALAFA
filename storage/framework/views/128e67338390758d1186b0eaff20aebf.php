...
<body class="bg-white">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-800 via-indigo-900 to-blue-950 flex-col justify-start p-16">
            <div class="mb-12">
                <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('unib-logo.png')))); ?>" alt="UNIB" class="w-40 object-contain mb-12">
            ...
            <div class="flex justify-center items-center">
                <div class="w-full" style="max-height: 6000px; overflow: hidden;">
                    <?php echo file_get_contents(public_path('ilus-unib.svg')); ?>
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            autofocus 
                            autocomplete="name"
                            class="w-full px-5 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 transition text-base <?php $__errorArgs = ['name'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="text-red-600 text-sm mt-2 block font-medium"><?php echo e($message); ?></span>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-5 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 transition text-base <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-5 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 transition text-base <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            required 
                            autocomplete="new-password"
                            class="w-full px-5 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 transition text-base <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-700">
                        Sudah punya akun? 
                        <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 hover:text-indigo-700 font-bold hover:underline">
                            Masuk di sini
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\laragon\www\skalafa-system\resources\views/auth/register.blade.php ENDPATH**/ ?>