        ...
        <div class="container mx-auto px-4 py-3 md:py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 md:space-x-4">
                    <a href="<?php echo e(route('survey.questionnaires', $questionnaire->faculty)); ?>" class="text-gray-600 hover:text-primary">
                        <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                    </a>
                    <img src="<?php echo e(asset('unib-logo.png')); ?>" alt="Logo UNIB" class="h-8 w-8 md:h-10 md:w-10">
                    <div class="min-w-0 flex-1">
                        <h1 class="text-lg md:text-xl font-bold text-primary truncate">Informasi Peserta</h1>
                        <p class="text-xs md:text-sm text-gray-600 truncate"><?php echo e($questionnaire->title); ?></p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-8 md:py-12">
        ...
        <div class="text-center mb-8 md:mb-12">
            ...
            <p class="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
                Silakan lengkapi informasi Anda sebelum memulai kuisioner <strong><?php echo e($questionnaire->title); ?></strong>
            </p>
        </div>

        <!-- Form -->
        <div class="max-w-2xl mx-auto px-4">
            <form action="<?php echo e(route('survey.save-participant-info', $questionnaire)); ?>" method="POST" class="bg-white rounded-xl shadow-lg p-6 md:p-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="Mahasiswa" <?php echo e(old('status') == 'Mahasiswa' ? 'selected' : ''); ?>>Mahasiswa</option>
                        <option value="Dosen" <?php echo e(old('status') == 'Dosen' ? 'selected' : ''); ?>>Dosen</option>
                        <option value="Staff" <?php echo e(old('status') == 'Staff' ? 'selected' : ''); ?>>Staff</option>
                        <option value="Alumni" <?php echo e(old('status') == 'Alumni' ? 'selected' : ''); ?>>Alumni</option>
                        <option value="Masyarakat Umum" <?php echo e(old('status') == 'Masyarakat Umum' ? 'selected' : ''); ?>>Masyarakat Umum</option>
                        <option value="Lainnya" <?php echo e(old('status') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                    </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skalafa-system\resources\views/survey/participant-info.blade.php ENDPATH**/ ?>