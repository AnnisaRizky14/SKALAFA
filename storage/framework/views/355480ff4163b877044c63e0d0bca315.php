...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div class="flex flex-col sm:flex-row items-center justify-between">
                <div class="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0 w-full sm:w-auto mb-2 sm:mb-0">
                    <a href="<?php echo e(route('survey.questionnaires', $questionnaire->faculty)); ?>" class="text-gray-600 hover:text-primary flex-shrink-0">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                        </svg>
                    </a>
                    <img src="<?php echo e(asset('unib-logo.png')); ?>" alt="Logo UNIB" class="h-8 w-8 sm:h-10 sm:w-10 flex-shrink-0">
                    <div class="min-w-0 flex-1">
                        <h1 class="text-lg sm:text-xl font-bold text-primary truncate"><?php echo e($questionnaire->title); ?></h1>
                        <p class="text-xs sm:text-sm text-gray-600 truncate"><?php echo e($questionnaire->faculty->name); ?></p>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
                <div class="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-medium text-gray-800 truncate">
                            Pertanyaan <span id="question-counter">0</span> dari <?php echo e($questionnaire->getTotalQuestions()); ?>
                ...
                <div class="text-left sm:text-right flex-shrink-0">
                    <p class="text-xs text-gray-500">Estimasi: <?php echo e($questionnaire->estimated_duration); ?> menit</p>
                    <p class="text-xs text-gray-500">Token: <?php echo e(substr($response->response_token, 0, 8)); ?>...</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="container mx-auto px-4 py-8">
        <form id="survey-form" action="<?php echo e(route('survey.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="response_token" value="<?php echo e($response->response_token); ?>">
            
            <!-- Instructions -->
            <?php if($questionnaire->instructions): ?>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <div class="text-blue-700 text-sm leading-relaxed">
                            <?php echo nl2br(e($questionnaire->instructions)); ?>
            ...
            <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $questions = $questionsGrouped->get($subcategory->id, collect()) ?>
                <?php if($questions->isNotEmpty()): ?>
                <div class="subcategory-section mb-12" data-subcategory="<?php echo e($subcategory->id); ?>">
                    <!-- Subcategory Header -->
                    <div class="bg-white rounded-t-xl border-l-4 border-primary p-6 shadow-lg">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs text-gray-500 mt-2"><?php echo e($questions->count()); ?> pertanyaan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-b-xl shadow-lg border-t border-gray-100">
                        ...
                        <div class="question-item p-6 border-b border-gray-100 last:border-b-0" data-question="<?php echo e($question->id); ?>">
...
<label class="rating-option cursor-pointer snap-center px-2 flex-shrink-0" style="min-width: unset;">
    <input type="radio"
           name="answers[<?php echo e($question->id); ?>][rating]"
    ...
    <div class="rating-card bg-gray-50 border-2 border-gray-200 rounded-lg p-3 text-center transition-all duration-200 hover:border-primary hover:bg-blue-50 min-h-[80px] flex flex-col justify-center">
                                                    ...
                                                    <div class="flex justify-center mb-1 sm:mb-2">
                                                        ...
                                                        <svg class="w-3 h-3 sm:w-4 sm:h-4 <?php echo e($star <= $rating ? 'text-yellow-400' : 'text-gray-300'); ?>"
                                                    ...
                                                    <div class="text-lg sm:text-2xl font-bold text-gray-700 mb-1"><?php echo e($rating); ?></div>
                                                    <div class="text-xs text-gray-600 leading-tight">
                                                        <?php switch($rating):
                                                            case (1): ?> Sangat Tidak Puas <?php break; ?>
                                                            <?php case (2): ?> Tidak Puas <?php break; ?>
                                                            <?php case (3): ?> Cukup Puas <?php break; ?>
                                                            <?php case (4): ?> Puas <?php break; ?>
                                                            <?php case (5): ?> Sangat Puas <?php break; ?>
                                                        <?php endswitch; ?>
                                                    </div>
                                                </div>
                                            </label>
...
<div class="mt-4">
    ...
    <textarea name="answers[<?php echo e($question->id); ?>][comment]"
              rows="3"
...
<script>
let totalQuestions = <?php echo e($questionnaire->getTotalQuestions()); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skalafa-system\resources\views/survey/questions.blade.php ENDPATH**/ ?>