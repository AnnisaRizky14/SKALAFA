<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Pastikan akun Anda menggunakan kata sandi yang panjang dan acak untuk tetap aman.')); ?>
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'password-updated'): ?>
                ...
                ><?php echo e(__('Disimpan.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\laragon\www\skalafa-system\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>