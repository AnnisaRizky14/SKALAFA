    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-12">
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-xl p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="flex items-center">
                                        <?php if($faculty->logo): ?>
                                            <img class="h-10 w-10 rounded-lg object-cover mr-3"
                                                 src="<?php echo e(asset('storage/images/faculties/' . $faculty->logo)); ?>"
                                        ...
                                        <?php else: ?>
                                            <div class="h-10 w-10 rounded-lg mr-3 flex items-center justify-center text-white font-bold text-sm"
                                                 style="background-color: <?php echo e($faculty->color); ?>">
                                                <?php echo e(substr($faculty->name, 0, 1)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900"><?php echo e($faculty->short_name ?? '-'); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($faculty->order); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="<?php echo e(route('admin.faculties.show', $faculty)); ?>"
                                        ...
                                        <?php if(auth()->user()->isSuperAdmin() || auth()->user()->isFacultyAdmin()): ?>
                                        <a href="<?php echo e(route('admin.faculties.edit', $faculty)); ?>"
                                        ...
                                        <?php endif; ?>
                                        <?php if(auth()->user()->isSuperAdmin()): ?>
                                        <form method="POST" action="<?php echo e(route('admin.faculties.destroy', $faculty)); ?>"
                ...
                <!-- Pagination -->
                <?php if($faculties->hasPages()): ?>
                <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                    <?php echo e($faculties->appends(request()->query())->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\skalafa-system\resources\views/admin/faculties/index.blade.php ENDPATH**/ ?>