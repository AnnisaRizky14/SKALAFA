        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('survey.faculties')); ?>" class="text-gray-600 hover:text-primary">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($faculty->name); ?></p>
                    </div>
                </div>
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Silakan pilih kuisioner yang ingin Anda isi untuk fakultas <strong><?php echo e($faculty->name); ?></strong>
            </p>
        </div>

<!-- Search Form -->
<div class="mb-8">
    <form method="GET" action="<?php echo e(route('survey.questionnaires', $faculty)); ?>" class="max-w-lg mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div class="questionnaire-card bg-white rounded-xl shadow-lg overflow-hidden card-hover transform transition-all duration-300">
                ...
                <div class="h-32 flex items-center justify-center text-white text-2xl font-bold relative overflow-hidden faculty-bg">
                    ...
                    <span class="relative z-10"><?php echo e($faculty->short_name); ?></span>

                    <!-- Background Pattern -->
                    <div class="absolute inset-0 opacity-10">
                        <svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <pattern id="pattern-<?php echo e($questionnaire->id); ?>" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                                    <circle cx="10" cy="10" r="2" fill="white" opacity="0.3"/>
                                </pattern>
                            </defs>
                            <rect width="100" height="100" fill="url(#pattern-<?php echo e($questionnaire->id); ?>)"/>
                        </svg>
                    </div>
                </div>
                ...
                <!-- Questionnaire Info -->
                <div class="p-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-2"><?php echo e($questionnaire->title); ?></h3>
                    <?php if($questionnaire->description): ?>
                    <p class="text-sm text-gray-600 mb-4 leading-relaxed"><?php echo e(Str::limit($questionnaire->description, 120)); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between text-sm border-t pt-4">
                        <div class="flex items-center text-gray-500">
                            ...
                            <?php echo e($questionnaire->responses()->where('is_completed', true)->count()); ?> responden
                        </div>

                        <?php $avgRating = $questionnaire->getAverageRating() ?>
                        <?php if($avgRating > 0): ?>
                        <div class="flex items-center">
                            ...
                            <span class="text-xs text-gray-600"><?php echo e(number_format($avgRating, 1)); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php $subcategories = $questionnaire->questions()->with('subCategory')->get()->pluck('subCategory')->unique() ?>
                    <?php if($subcategories->isNotEmpty()): ?>
                    <div class="mt-3">
                        <p class="text-xs text-gray-500 mb-2">Sub-bab:</p>
                        <div class="flex flex-wrap gap-1">
                            <?php $__currentLoopData = $subcategories->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">
                                <?php echo e($subcategory->name); ?>

                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($subcategories->count() > 3): ?>
                            <span class="inline-block bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded-full">
                                +<?php echo e($subcategories->count() - 3); ?> lainnya
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <a href="<?php echo e(route('survey.participant-info', $questionnaire)); ?>"
        ...
        <div class="text-center py-16">
            ...
            <a href="<?php echo e(route('survey.faculties')); ?>" class="inline-flex items-center px-6 py-3 btn-primary rounded-lg font-semibold">
...
<style>
    .faculty-bg {
        background-color: <?php echo e($faculty->color); ?>;
    }
</style>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skalafa-system\resources\views/survey/questionnaires.blade.php ENDPATH**/ ?>