...
<div class="min-h-screen gradient-bg">
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <div class="text-center text-white mb-16">
            ...
            <a href="<?php echo e(route('survey.faculties')); ?>" class="inline-flex items-center px-8 py-4 bg-white text-primary font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white border-2 border-gray-100 rounded-xl p-6 card-hover cursor-pointer" onclick="window.location.href='<?php echo e(route('survey.questionnaires', $faculty)); ?>'">
                    <div class="text-center">
                        <!-- Faculty Icon/Logo -->
                        <div class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white text-1xl font-bold" style="background-color: <?php echo e($faculty->color); ?>">
                            <?php echo e($faculty->short_name); ?>

                        </div>
                        
                        <h4 class="text-lg font-semibold text-gray-800 mb-2"><?php echo e($faculty->name); ?></h4>
                        <p class="text-sm text-gray-600 mb-4"><?php echo e($faculty->description); ?></p>
                        
                        <!-- Statistics -->
                        <?php $stats = $faculty->getSatisfactionStats() ?>
                        <div class="flex justify-between text-xs text-gray-500 border-t pt-3">
                            <span><?php echo e($stats['total_responses']); ?> Responden</span>
                            <?php if($stats['average_rating'] > 0): ?>
                                <span class="flex items-center">
                                    <svg class="w-3 h-3 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <?php echo e($stats['average_rating']); ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center mb-12">
            ...
            <a href="<?php echo e(route('survey.faculties')); ?>" class="inline-flex items-center px-8 py-4 btn-primary rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <a href="<?php echo e(route('complaints.index')); ?>" class="inline-flex items-center px-8 py-4 bg-red-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<footer class="text-white py-12 border-t-4 border-primary-600" style="background-color: #003f7f;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-start gap-8 flex-wrap">
            ...
            <div class="text-left">
                <div class="flex items-start mb-4">
                    <img class="h-14 w-auto" src="<?php echo e(asset('unib-logo.png')); ?>" alt="UNIB Logo">
                    <div class="ml-3">
        ...
        <div class="border-t border-unib-blue-700 mt-8 pt-8 text-center text-unib-blue-200">
            <p>&copy; <?php echo e(date('Y')); ?> Prodi Sistem Informasi Fakultas Teknik Universitas Bengkulu. All rights reserved.</p>
        </div>
    </div>
</footer>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skalafa-system\resources\views/survey/dashboard.blade.php ENDPATH**/ ?>