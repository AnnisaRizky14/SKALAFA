<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Setelah akun Anda dihapus, semua sumber daya dan data yang terkait dengan akun tersebut akan dihapus secara permanen. Sebelum menghapus akun Anda, silakan unduh semua data atau informasi yang ingin Anda simpan.')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                <?php echo e(__('Setelah akun Anda dihapus, semua sumber daya dan data di dalamnya akan dihapus secara permanen. Silakan masukkan kata sandi Anda untuk mengonfirmasi bahwa Anda ingin menghapus akun Anda secara permanen.')); ?>
...
<?php /**PATH C:\laragon\www\skalafa-system\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>