    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-center">
                <img src="<?php echo e(asset('unib-logo.png')); ?>" alt="Logo UNIB" class="h-10 w-10 mr-3">
        ...
        <div class="max-w-2xl mx-auto text-center">
            ...
            <div class="space-y-4">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('survey.dashboard')); ?>"
                ...
                <p class="text-sm text-gray-500">
                    ...
                    <a href="<?php echo e(route('survey.faculties')); ?>" class="text-primary hover:underline font-medium">
    ...
    <footer class="bg-primary text-white py-8 mt-16">
        <div class="container mx-auto px-4 text-center">
            <div class="flex items-center justify-center mb-4">
                <img src="<?php echo e(asset('unib-logo.png')); ?>" alt="Logo UNIB" class="h-8 w-8 mr-3">
            ...
            <p class="text-xs opacity-50">
                © <?php echo e(date('Y')); ?> Universitas Bengkulu. Semua hak dilindungi.
            </p>
        </div>
    </footer>
</div>
...
function shareToWhatsApp() {
    const url = "<?php echo e(route('survey.dashboard')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\skalafa-system\resources\views/survey/thank-you.blade.php ENDPATH**/ ?>